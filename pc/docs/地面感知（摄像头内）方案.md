...
| C3 | **按需会话**：切到「感知」后默认 Idle；点 **「开始感知」** 才跑算法；**停止**或切回 RGB/Depth 即 teardown |
...
4. 可选：点「打开 3D」→ `Ros2BridgeManager.start_rviz(xtark_ground_perception.rviz)`
...
- [x] Phase1: CameraViewModeBar 增「感知」+ 开始/停止
