"""Local config for Jetson onboard Qt cockpit."""
...
def load_config() -> CockpitConfig:
    ...
    return CockpitConfig(
        ...
        log_dir=_path(env_file, "QT_COCKPIT_LOG_DIR", "logs"),
        log_level=_value(env_file, "QT_COCKPIT_LOG_LEVEL", "INFO").upper(),
        web_control_url=_value(
            env_file, "WEB_CONTROL_URL", "http://172.0.0.82:8080/ctl"
        ),
    )
