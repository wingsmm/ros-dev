#!/usr/bin/env python3
"""Write run_xtark.sh with Unix LF line endings (safe on Windows checkout)."""
from pathlib import Path

RUN_XTARK_SH = r"""#!/bin/bash
set -eo pipefail
...
path = Path(__file__).resolve().parent / "run_xtark.sh"
with path.open("w", encoding="utf-8", newline="\n") as f:
    f.write(RUN_XTARK_SH)
path.chmod(0o755)
print("OK:", path)
