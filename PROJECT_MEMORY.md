...
This file is no longer the primary instruction source for Codex or other agents.
...
For new durable guidance, prefer updating the relevant canonical doc or `AGENTS.md`.
Do not add fresh operational rules here unless this file is intentionally reactivated.
