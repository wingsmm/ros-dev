    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="Mapping backend: vendor_point_lio or simple_frontend.",
            ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare("slam_bringup"), "launch", "vendor_point_lio_mapping.launch.py"]
                    )
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare("slam_perception"), "launch", "stair_detector.launch.py"]
                    )
                ),
            ),
        ]
