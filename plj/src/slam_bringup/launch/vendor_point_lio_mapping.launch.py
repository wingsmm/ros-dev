...
def generate_launch_description():
    ...
    sam_config = LaunchConfiguration("sam_config")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "sam_config",
                default_value=PathJoinSubstitution(
                    [FindPackageShare("slam_bringup"), "config", "sam_qn_mapping.yaml"]
                ),
            ),
            ...
            Node(
                ...
                arguments=[
                    "-d",
                    PathJoinSubstitution([FindPackageShare("point-lio-slam"), "rviz", "sam_rviz.rviz"]),
                ],
